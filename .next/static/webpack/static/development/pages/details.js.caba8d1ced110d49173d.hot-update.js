...
function CenteredGrid(_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("main", {
    ...
    src: "https://maps.googleapis.com/maps/api/staticmap?center=".concat(park.latLong.length > 0 ? park.latLong.replace(/[^\d.,-]/g, '') : park.fullName.replace(/\s/g, '', "") + "," + park.fullName.replace(/\s/g, '', "") + "," + park.states, "&zoom=12&size=1300x400&scale=2&maptype=terrain&key=").concat(GOOGLE_API_KEY)
  }))));
}
...
//# sourceMappingURL=details.js.caba8d1ced110d49173d.hot-update.js.map