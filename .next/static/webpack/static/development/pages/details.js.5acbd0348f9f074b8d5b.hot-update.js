...
function CenteredGrid(_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("main", {
    ...
    src: "https://maps.googleapis.com/maps/api/staticmap?center=".concat(park.latLong.length > 0 ? park.latLong.replace(/[^\d.,-]/g, '') : park.fullName.replace(/\s/g, '', "") + "," + park.fullName.replace(/\s/g, '', "") + "," + park.states, "&zoom=12&size=1300x1300&scale=2&maptype=terrain&key=").concat(GOOGLE_API_KEY)
  }))));
}
...
//# sourceMappingURL=details.js.5acbd0348f9f074b8d5b.hot-update.js.map