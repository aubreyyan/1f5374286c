...
/* harmony import */ var _static_default_css__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ../static/default.css */ "./static/default.css");
/* harmony import */ var _static_default_css__WEBPACK_IMPORTED_MODULE_34___default = /*#__PURE__*/__webpack_require__.n(_static_default_css__WEBPACK_IMPORTED_MODULE_34__);
...
function CenteredGrid(_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_4___default.a.createElement("main", {
    ...
    return react__WEBPACK_IMPORTED_MODULE_4___default.a.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_10__["Grid"], {
      ...
      src: "https://maps.googleapis.com/maps/api/staticmap?center=".concat(campObj.latLong.length > 0 ? campObj.latLong.replace(/[^\d.,-]/g, '') : campObj.name.replace(/\s/g, '', "") + "," + name.replace(/\s/g, '', "") + "," + state, "&zoom=15&size=1000x350&scale=2&maptype=terrain&key=").concat(GOOGLE_API_KEY)
    }))))));
...
//# sourceMappingURL=campgrounds.js.caa38da195dcd89633c9.hot-update.js.map